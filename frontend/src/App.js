...
const App = () => {
  ...
  const skills = [
    { icon: '📋', name: 'Requirements Elicitation', category: 'BUSINESS ANALYSIS', color: '#00d4ff' },
    { icon: '📋', name: 'BRD & FRD Documentation', category: 'DOCUMENTATION', color: '#ff6b6b' },
    { icon: '📚', name: 'Use Case Development', category: 'BUSINESS ANALYSIS', color: '#4ecdc4' },
    { icon: '📋', name: 'User Story Creation', category: 'AGILE', color: '#45b7d1' },
    { icon: '🔄', name: 'Change Impact Analysis', category: 'PROCESS', color: '#f107a3' },
    { icon: '💾', name: 'SQL Queries & Validation', category: 'TECHNICAL', color: '#96ceb4' },
    { icon: '📊', name: 'Power BI Dashboards', category: 'ANALYTICS', color: '#ffeaa7' },
    { icon: '📊', name: 'Advanced Excel', category: 'ANALYTICS', color: '#55efc4' },
    { icon: '✅', name: 'Data Quality Assurance', category: 'QUALITY ASSURANCE', color: '#81ecec' },
    { icon: '💻', name: 'Python Programming', category: 'TECHNICAL', color: '#74b9ff' },
    { icon: '📦', name: 'ERP & SAP Systems', category: 'SYSTEMS', color: '#a29bfe' },
    { icon: '🧪', name: 'UAT Planning', category: 'TESTING', color: '#fd79a8' },
    { icon: '🧪', name: 'Test Case Execution', category: 'TESTING', color: '#fdcb6e' },
    { icon: '💾', name: 'System Integration', category: 'TECHNICAL', color: '#6c5ce7' },
    { icon: '📊', name: 'Workflow Optimization', category: 'PROCESS', color: '#00b894' },
    { icon: '📦', name: 'JIRA & Confluence', category: 'TOOLS', color: '#0984e3' },
    { icon: '⚙️', name: 'Postman', category: 'TOOLS', color: '#ff7675' },
    { icon: '📦', name: 'Microsoft 365', category: 'TOOLS', color: '#00cec9' },
    { icon: '📊', name: 'Tableau', category: 'ANALYTICS', color: '#e17055' },
    { icon: '🔄', name: 'Agile Methodology', category: 'AGILE', color: '#fab1a0' },
  ];
    ...
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <div className="container mx-auto px-4 pt-6">
        <div className="max-w-7xl mx-auto">
          <span className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#1a0a2e] via-[#2d1b4e] to-[#1a0a2e] border-2 border-[#00d4ff] rounded-full text-[#00d4ff] text-sm font-medium backdrop-blur-sm"
                style={{ boxShadow: '0 0 20px rgba(0, 212, 255, 0.3)' }}>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            Business Systems Analyst & Software Quality Assurance Engineer
          </span>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-left mb-8"
                style={{
                  background: 'linear-gradient(to right, #00d4ff, #7b2ff7, #f107a3)',
                  WebkitBackgroundClip: 'text',
                  WebkitTextFillColor: 'transparent',
                  backgroundClip: 'text',
                  filter: 'drop-shadow(0 0 20px rgba(0, 212, 255, 0.6)) drop-shadow(0 0 40px rgba(123, 47, 247, 0.4))'
                }}>
              About Me
            </h2>
      ...
      <section id="skills" className="py-20 bg-gradient-to-br from-[#0a0a0f] via-[#1a0a2e] to-[#0a0a0f]" data-testid="skills-section">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-left max-w-7xl mx-auto mb-12"
              style={{
                background: 'linear-gradient(to right, #00d4ff, #7b2ff7, #f107a3)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
